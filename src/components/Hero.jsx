...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute top-20 left-4 sm:left-10 w-48 sm:w-72 h-48 sm:h-72 bg-blue-900/10 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-20 right-4 sm:right-10 w-64 sm:w-96 h-64 sm:h-96 bg-cyan-900/10 rounded-full blur-3xl animate-pulse delay-1000" />
      ...
      <div className="max-w-7xl mx-auto text-center relative w-full mt-8">
        <div className="max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-2 text-center lg:text-left gap-6 sm:gap-8 lg:gap-12 items-center relative">
          <div>
            ...
            <h1 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold mb-4 sm:mb-6 animate-in-from-bottom duration-700 delay-100 leading-tight">
              <span className="bg-gradient-to-b from-white via-blue-100 to-cyan-100 bg-clip-text text-transparent block mb-1 sm:mb-2">
                Code Faster
              </span>

              <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-100 bg-clip-text text-transparent block mb-1 sm:mb-2">
                Build Better
              </span>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 sm:gap-4 animate-in slide-in-from-bottom duration-700 delay-300">
              ...
              <button className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 border border-gray-700 rounded-lg font-semibold text-sm sm:text-base text-gray-300 hover:bg-white/10 transition-all duration-300 flex items-center justify-center space-x-2">
          ...
          <div className="relative order-2 w-full">
            <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
              <div className="bg-gradient-to-br from-gray-900/20 to-gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-[280px] sm:h-[350px] lg:h-[450px] border border-white/5">
                ...
                {/* File Tabs */}
                <div className="p-3 sm:px-4 relative h-full">
                  <div className="flex space-x-1 sm:space-x-2 mb-3 sm:px-4 overflow-x-auto">
                    <button
                      onClick={() => setActiveTab("App.jsx")}
                      className={`px-3 py-2 backdrop-blur-none text-xs sm:text-sm rounded-t-lg border ${
                        activeTab === "App.jsx"
              ...
              {/* Floating Cards */}
              <div
                className={`hidden lg:block absolute bottom-4 right-4 transform translate-x-8 translate-y-8 w-72 ${currentFloatingCard.bgColor} backdrop-blur-xl rounded-lg p-4 border border-white/10 shadow-2xl`}
              >
