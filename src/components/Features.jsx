...
const featuresData = [
  ...
  },
  {
    ...
    description:
      "Intelligent code suggestions powered by advanced AI that learns from your coding patterns. Get real-time assistance with syntax, logic, and best practices.",
    codeSnippet: `test("submits form data", async () => {
            ...
            >
              ...
              <div className="flex-1 w-full">
                <div className="relative group">
                  ...
                  <div className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl sm:rounded-xl p-4 sm:p-6 overflow-hidden group-hover:border group-hover:border-blue-600/50 transition-all duration-300">
                    {/* IDE Interface */}
                    <div className="bg-gray-950 rounded-lg p-3 sm:p-4 lg:p-8 font-mono text-xs sm:text-sm">
